export const displayUserPhotoProfile = (img) => {
...
export const displayUserNamePlants = (plants) => {
    const div = document.getElementById("user-container");
...
export const displayPlantInformation = (allPlants) => {
    const div = document.getElementById("user-container");
...
export const displayUserPlants = (allPlants, userPlant) => {
    userPlant.forEach((u) => {
